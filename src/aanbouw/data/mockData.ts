...
export const bouwbedrijven: Bouwbedrijf[] = [
  ...
  },
  {
    ...
    status: 'actief', verified: true,
    services: ['aanbouw', 'uitbouw', 'garage-ombouw', 'veranda', 'tuinkantoor', 'gevelafwerking', 'vergunning-begeleiding'],
  ...
  },
  {
    ...
    services: ['aanbouw', 'uitbouw', 'dakopbouw', 'staalconstructie', 'schuifpui', 'prefab-woning'],
