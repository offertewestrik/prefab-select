        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="mt-10">
                <Link to="https://prefabselectconfigurator.nl" target="_blank" className="inline-flex items-center gap-3 px-10 py-5 bg-blue-950 text-white rounded-xl font-black uppercase tracking-widest text-[11px] shadow-lg hover:bg-blue-900 transition-all">
