    ...
    <div className="bg-white min-h-screen pt-0 font-sans">
      ...
      <section className="relative h-[80vh] md:h-screen min-h-[600px] md:min-h-[800px] flex items-center justify-center overflow-hidden bg-blue-950">
        <div className="absolute inset-0">
          {/* We emulate video with an image if the video URL isn't a direct mp4, but it is requested as 'video/visual' so we use img for now, with zoom effect */}
          <motion.img 
            initial={{ scale: 1.1 }}
            animate={{ scale: 1 }}
            transition={{ duration: 10, ease: 'easeOut' }}
            src="https://i.imgur.com/qTIctyr.jpeg" // assuming it's a jpeg for now from the imgur id if not a video link.
            alt="Prefab Uitbouw Architectuur" 
            className="w-full h-full object-cover opacity-50"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-950/90 via-blue-950/50 to-transparent" />
        </div>
        
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-24 md:pt-32">
          <div className="max-w-3xl">
            ...
            >
              <div className="inline-block px-4 py-2 border border-blue-400/30 rounded-full mb-6 md:mb-8 backdrop-blur-md">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-300">
                  PREFAB UITBOUW
                </span>
              </div>
              <h1 className="text-3xl md:text-5xl lg:text-7xl font-display font-black text-white uppercase tracking-tighter leading-[1] md:leading-[0.9] mb-6 md:mb-8">
                Moderne prefab uitbouwen met hoogwaardige afwerking.
              </h1>
              <p className="text-lg md:text-2xl text-blue-100/70 mb-8 md:mb-12 font-light leading-relaxed max-w-2xl">
      ...
      {/* SECTIE 2 — WAT IS EEN PREFAB UITBOUW? */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="prose prose-lg text-slate-600 mb-12">
                <p className="mb-6">
                  Een prefab uitbouw is een moderne woninguitbreiding die grotendeels vooraf in de fabriek wordt geproduceerd. Hierdoor kan de plaatsing op locatie aanzienlijk sneller verlopen dan bij traditionele bouwmethodes.
                </p>
                <p className="mb-6">
      ...
      <section id="mogelijkheden" className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Moderne woonuitbreidingen", desc: "Creëer extra leefruimte met een moderne prefab uitbouw volledig afgestemd op jouw woning.", icon: <Home size={24} /> },
              ...
              { title: "Uitbouwen met lichtstraat", desc: "Meer daglicht en een luxe uitstraling dankzij moderne lichtstraten en grote glaspartijen.", icon: <Sun size={24} /> },
              ...
              { title: "Volledig maatwerk", desc: "Iedere prefab uitbouw wordt afgestemd op jouw wensen, woning en architectuur.", icon: <PenTool size={24} /> },
            ].map((card, i) => (
              <motion.div 
                key={i}
      ...
      <section className="py-24 md:py-32 bg-slate-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-slate-600 mb-16 max-w-2xl mx-auto">
            De kosten van een prefab uitbouw hangen af van afmetingen, afwerking, kozijnen en luxe opties zoals lichtstraten of schuifpuien.
          </p>
