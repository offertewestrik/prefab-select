...
export const regioData: Record<string, RegioData> = {
  ...
  arnhem: {
    ...
    heroImage: 'https://i.imgur.com/v4jk0SK.jpeg',
    processImage: 'https://i.imgur.com/6VuTqto.jpeg',
    metaTitle: 'Uitbouw in Arnhem | Prefab uitbouw op maat — Prefab Select',
    metaDescription: 'Een prefab uitbouw in Arnhem laten bouwen? Lees alles over kosten, vergunning, de stuwwal- en rivierbodem en de aanpak per wijk. Prefab Select bouwt snel en vakkundig.',
    heroBadge: 'PREFAB SELECT ARNHEM',
    heroTitleLines: ['Uitbouw in Arnhem', 'meer ruimte aan', 'de veluwezoom'],
    heroIntro: 'Arnhem is een groene, levendige stad tussen de Veluwe en de Rijn. Wilt u uw woning vergroten zonder de stress van een lange verbouwing? Prefab Select bouwt een stabiel gefundeerde, hoogwaardig geïsoleerde uitbouw — snel geplaatst en met minimale overlast in uw straat.',
    usps: [
      { title: 'Constructie in 1 dag', sub: 'Ruwbouw direct wind- & waterdicht' },
      { title: 'Stabiele fundering', sub: 'Stuwwal- én rivierbodem' },
      { title: 'Hoge isolatie', sub: 'Rc 6.0 voor een laag verbruik' },
    ],
    introEyebrow: 'UITBREIDEN IN PLAATS VAN VERHUIZEN',
    introHeading: ['Investeren op de plek', 'die u al koestert'],
    introParagraphs: [
      'Arnhem is een geliefde woonstad, met de bossen van de Veluwezoom in het noorden en de levendige stad aan de Rijn. Wie hier woont — of dat nu in het sfeervolle Spijkerkwartier, het kleurrijke Klarendal of het groene Schaarsbergen is — verlaat zijn buurt niet graag. Met een prefab uitbouw hoeft dat ook niet.',
      'Met een hoogwaardige uitbouw van Prefab Select vergroot u uw begane grond aanzienlijk: een royale leefkeuken, een lichte woonkamer of een werkplek aan huis. U wint vierkante meters én daglicht, en verhoogt tegelijk de waarde van uw woning op de gewilde Arnhemse huizenmarkt.',
      'Wij begeleiden u van het eerste ontwerp tot de oplevering, met aandacht voor de specifieke bouwstijlen en de gevarieerde ondergrond van Arnhem.',
    ],
    benefits: [
      'Binnen 1 dag op locatie geplaatst, direct wind- en waterdicht',
      'In droge, gecontroleerde fabrieksomstandigheden gefabriceerd',
    ...
    processHeading: ['Snel, droog fabricageproces', 'en een geruisloze opbouw'],
    processParagraphs: [
      'Klassieke aanbouw op locatie brengt weersrisico’s, lange droogtijden en geluidsoverlast met zich mee. Prefab Select keert dat om: wij bereiden alle wanden, kozijnen, daken en vloerelementen zorgvuldig voor in onze eigen fabriek, vrij van weersinvloeden.',
      'Terwijl die elementen droog ontstaan, leggen we bij u thuis een solide fundering aan, afgestemd op de Arnhemse ondergrond. Op de montagedag hijsen we de constructie op haar plek; dezelfde avond is uw woning weer volledig wind- en waterdicht. Daarna volgt alleen nog de fijne afwerking.',
    ],
    welstandEyebrow: 'VERGUNNING & ONDERGROND IN ARNHEM',
    welstandHeading: ['Vergunningsvrij waar het kan', 'zorgvuldig waar het moet'],
    welstandParagraphs: [
      'De landelijke regels bieden ruime mogelijkheden: een uitbouw aan de achterzijde binnen het achtererfgebied is vaak vergunningsvrij, als richtlijn tot vier meter diep, mits voldoende achtererf onbebouwd blijft. Wij doen kosteloos de vergunningcheck voor uw adres bij de gemeente Arnhem.',
      'In beschermde stadsgezichten zoals delen van het Spijkerkwartier en bij monumenten is wel een omgevingsvergunning en welstandsadvies nodig. Onze ontwerpers verzorgen het complete traject, inclusief tekeningen en gemeentelijk overleg.',
      'Arnhem ligt deels op de hoge, stevige zandgronden van de stuwwal en deels in het lager gelegen rivierengebied. Afhankelijk van uw locatie funderen wij op staal of op palen. Wij berekenen dit altijd vooraf, zodat uw uitbouw levenslang stabiel en scheurvrij blijft.',
    ],
    costHeading: 'Wat kost een uitbouw in Arnhem?',
    ...
    costRows: [
      { label: 'Prefab uitbouw, per m² (geïnstalleerd)', val: 'circa € 2.600 – € 4.300' },
      { label: 'Compacte uitbouw (ca. 12 m²)', val: 'vanaf circa € 42.000' },
      { label: 'Ruime of luxe uitbouw (ca. 20 m²)', val: 'tot € 85.000 of meer' },
    ],
    costNote: '* Richtbedragen incl. btw en installatie. In het lager gelegen rivierengebied van Arnhem kan een diepere paalfundering nodig zijn; op de zandgronden van de stuwwal volstaat doorgaans een eenvoudiger fundering.',
    steps: [
      { nr: '1', title: 'Advies & Ontwerp', desc: 'We bekijken uw woning in Arnhem, bespreken uw wensen en ontwerpen een uitbouw op maat.' },
      { nr: '2', title: 'Vergunningscheck', desc: 'Gratis controle bij de gemeente Arnhem; waar nodig regelen wij de volledige aanvraag.' },
      { nr: '3', title: 'Fabricage', desc: 'In onze droge fabriek bouwen we wanden, kozijnen en daken millimeterprecies.' },
      { nr: '4', title: 'Fundering & Montage', desc: 'Stevige fundering op stuwwal- of rivierbodem en plaatsing in één dag, wind- en waterdicht.' },
      { nr: '5', title: 'Afwerking', desc: 'Beglazing, elektra en afwerking worden voltooid. Uw nieuwe ruimte is direct gebruiksklaar.' },
    ],
    districtsHeading: 'Bouwen per wijk in Arnhem',
    districtsIntro: 'Arnhem kent uiteenlopende wijken met eigen bouwstijlen en ondergronden. Wij stemmen ons ontwerp daarop af:',
    wijken: [
      { name: 'Spijkerkwartier & Klarendal', desc: 'Karaktervolle stadswijken waar de welstand scherp toeziet. Onze ontwerpen sluiten zorgvuldig aan op de bestaande architectuur.' },
      { name: 'Schaarsbergen & Alteveer', desc: 'Groene, ruime wijken aan de Veluwezoom met goede achterom-mogelijkheden, ideaal voor royale uitbouwen.' },
      { name: 'Malburgen & Elden', desc: 'Wijken in het rivierengebied, waar we extra aandacht besteden aan een diepe, stabiele fundering.' },
    ],
    analysisBoxes: [
      { eyebrow: 'DE JUISTE KEUZE', title: 'Is een uitbouw de beste oplossing?', paragraphs: ['Zoekt u extra meters op de begane grond — een royale leefkeuken, een kantoor of een lichte eetkamer — dan is een uitbouw veruit de meest gewenste optie.', 'Heeft u juist boven ruimte nodig? Dan adviseren wij u graag over een dakkapel of dakopbouw die past binnen de Arnhemse regels.'] },
      { eyebrow: 'GOEDE VOORBEREIDING', title: 'Grondige voorbereiding geeft rust', paragraphs: ['Kraantoegankelijkheid, erfgrenzen en de ondergrond — stuwwal of rivierklei — schatten we vooraf nauwkeurig in.', 'Onze engineers lopen al deze facetten met u door vóór de fabricage, zodat meerwerk of vertraging wordt uitgesloten.'] },
      { eyebrow: 'LICHT & SFEER', title: 'Daglicht en ruimtebeleving', paragraphs: ['Een uitbouw voegt niet alleen meters toe, maar verandert hoe u woont. Met een glazen achtergevel of lichtstraat haalt u het groen van de Veluwezoom naar binnen.', 'Zo verbindt u binnen en buiten en wordt uw woonkamer een lichte, ruimtelijke plek.'] },
      { eyebrow: 'DUURZAAM COMFORT', title: 'Tochtvrij en energiezuinig', paragraphs: ['Onze prefab wanden, vloeren en daken halen isolatiewaarden tot Rc 6.0. Tocht en warmteverlies behoren tot het verleden.', 'Dat verlaagt direct uw energierekening en combineert perfect met vloerverwarming of een warmtepomp.'] },
    ],
    extraBlocks: [
      { heading: 'Uw woning in Arnhem optimaal benutten', paragraphs: [
        'Arnhem heeft een gevarieerde woningvoorraad: van karakteristieke vooroorlogse panden in het Spijkerkwartier tot ruime naoorlogse gezinswoningen en moderne huizen aan de stadsranden. Voor vrijwel elk type biedt een prefab uitbouw een logische manier om extra leefruimte te winnen.',
        'Onze ontwerpers stemmen de gevel, kozijnen en dakafwerking af op uw bestaande woning, zodat de uitbouw oogt alsof hij er altijd al was. Een krappe keuken wordt zo een royale leefkeuken en een donkere woonkamer krijgt licht via een ruime schuifpui.'] },
      { heading: 'Waardevermeerdering op de Arnhemse markt', paragraphs: [
        'Op de gewilde huizenmarkt van Arnhem is extra woonoppervlak goud waard. Een uitbouw vertaalt zich vrijwel altijd in een hogere taxatie- en verkoopwaarde, zeker nu ruimte schaars is. U investeert dus in uw dagelijks woongenot én in uw vermogen.',
        'Met isolatiewaarden tot Rc 6.0 en voorbereiding op vloerverwarming en een warmtepomp bouwt u bovendien toekomstbestendig. Dat houdt uw woning aantrekkelijk en uw energierekening laag.'] },
    ],
    faqs: [
      { question: 'Wat kost een prefab uitbouw in Arnhem?', answer: 'Gemiddeld € 2.600 tot € 4.300 per m². Een uitbouw van 15 m² ligt doorgaans tussen € 45.000 en € 62.000, afhankelijk van afwerking, kozijnen en fundering. U ontvangt altijd een heldere offerte vooraf.' },
      { question: 'Heb ik een vergunning nodig in Arnhem?', answer: 'Een uitbouw aan de achterkant is vaak vergunningsvrij tot vier meter diep binnen het achtererfgebied. Bij monumenten of in beschermde stadsgezichten geldt een vergunningplicht. Wij checken dit gratis voor uw adres.' },
      { question: 'Moet ik letten op de fundering in Arnhem?', answer: 'Dat hangt af van uw locatie. Op de stuwwal volstaat vaak een eenvoudiger fundering; in het lager gelegen rivierengebied is een diepere paalfundering verstandig. Wij berekenen dit altijd vooraf.' },
      { question: 'Hoelang duurt het plaatsen van een uitbouw?', answer: 'De ruwbouw staat doorgaans binnen één dag wind- en waterdicht. Inclusief fundering en afwerking bent u meestal binnen 4 tot 6 weken volledig klaar.' },
      { question: 'Kan ik een keuken in de uitbouw plaatsen?', answer: 'Ja, dat doen we regelmatig. Alle leidingen, afvoeren en elektra worden al in de fabriek voorbereid, zodat uw keuken naadloos aansluit.' },
      { question: 'Is prefab wel stevig genoeg?', answer: 'Absoluut. Alles wordt onder gecontroleerde fabrieksomstandigheden gebouwd, wat een constantere en vaak hogere kwaliteit oplevert dan bouwen op locatie.' },
    ],
    noscript: 'Prefab Select bouwt hoogwaardige prefab uitbouwen en aanbouwen in Arnhem, waaronder het Spijkerkwartier, Klarendal, Schaarsbergen en Malburgen. Een uitbouw aan de achterzijde is vaak vergunningsvrij tot vier meter diep. Arnhem ligt deels op de stuwwal (zandgrond) en deels in het rivierengebied; wij berekenen de juiste fundering vooraf. Richtprijs circa € 2.600 tot € 4.300 per m². Offerte aanvragen? Mail offerte@prefabselect.nl of bezoek www.prefabselect.nl.',
  },
  ...
  apeldoorn: {
    ...
    heroImage: 'https://i.imgur.com/6VuTqto.jpeg',
    processImage: 'https://i.imgur.com/v4jk0SK.jpeg',
    metaTitle: 'Uitbouw in Apeldoorn | Prefab uitbouw op maat — Prefab Select',
    metaDescription: 'Een prefab uitbouw in Apeldoorn laten bouwen? Lees over kosten, vergunning, bouwen op de Veluwse zandgrond en de aanpak per wijk. Prefab Select bouwt snel en vakkundig.',
    heroBadge: 'PREFAB SELECT APELDOORN',
    heroTitleLines: ['Uitbouw in Apeldoorn', 'ruim wonen aan', 'de veluwe'],
    heroIntro: 'Apeldoorn staat bekend om zijn ruime, groene wijken aan de rand van de Veluwe. Wilt u uw woning vergroten zonder gedoe? Prefab Select bouwt een hoogwaardig geïsoleerde uitbouw — snel geplaatst, stabiel op de zandgrond en met minimale overlast.',
    usps: [
      { title: 'Constructie in 1 dag', sub: 'Ruwbouw direct wind- & waterdicht' },
      { title: 'Stabiel op zandgrond', sub: 'Snelle, vaste fundering' },
      { title: 'Hoge isolatie', sub: 'Rc 6.0 voor een laag verbruik' },
    ...
    introEyebrow: 'UITBREIDEN IN PLAATS VAN VERHUIZEN',
    introHeading: ['Ruimte winnen op', 'uw favoriete plek'],
    introParagraphs: [
      'Apeldoorn is geliefd om zijn groene, ruim opgezette wijken en de Veluwe voor de deur. Of u nu woont in De Maten, het gemoedelijke Ugchelen of dichter bij het centrum: het is een plek waar mensen graag blijven wonen. Met een prefab uitbouw creëert u eenvoudig de extra ruimte die u zoekt.',
      'Met een uitbouw van Prefab Select vergroot u uw woonkamer of keuken en haalt u meer daglicht binnen. Dankzij de vaak ruime kavels in Apeldoorn is er volop plek voor grote schuifpuien of een lichtstraat, zodat u het Veluwse groen letterlijk in huis haalt.',
      'Het is een investering die zich direct vertaalt in wooncomfort én in de waarde van uw woning.',
    ],
    benefits: [
      'Binnen 1 dag op locatie geplaatst, direct wind- en waterdicht',
      'Ruime kavels bieden volop ontwerpvrijheid',
      'Snelle, stabiele plaatsing op de Veluwse zandgrond',
      'Hoogwaardige isolatie tot Rc 6.0 voor een lage energierekening',
    ],
    processEyebrow: 'GEEN MAANDENLANGE BOUWPLAATS',
    processHeading: ['Droog gebouwd in de fabriek', 'snel gemonteerd op locatie'],
    processParagraphs: [
      'Traditionele aanbouw brengt weersrisico’s, droogtijden en geluidsoverlast met zich mee. Prefab Select bouwt het grootste deel van uw uitbouw vooraf in de fabriek, onder droge en constante omstandigheden.',
      'Op uw kavel leggen we een stevige fundering aan op de zandgrond. Op de montagedag plaatsen we de voorbereide elementen met een kraan; dezelfde avond is uw woning weer wind- en waterdicht. Daarna volgt alleen nog de fijne afwerking.',
    ],
    welstandEyebrow: 'VERGUNNING & ONDERGROND IN APELDOORN',
    welstandHeading: ['Vaak vergunningsvrij', 'altijd goed geregeld'],
    welstandParagraphs: [
      'Een uitbouw aan de achterzijde binnen het achtererfgebied is vaak vergunningsvrij, als richtlijn tot vier meter diep. Wij voeren kosteloos de vergunningcheck uit voor uw adres bij de gemeente Apeldoorn.',
      'In het buitengebied, bij monumenten of in beschermde zones kunnen aanvullende regels gelden. Onze ontwerpers verzorgen waar nodig het volledige vergunnings- en welstandstraject.',
      'Apeldoorn ligt op de stevige zandgrond van de Veluwe. Dat is gunstig: het maakt een snelle en stabiele plaatsing mogelijk, vaak met een eenvoudiger fundering dan in poldergebied. Wij beoordelen de ondergrond altijd per locatie.',
    ],
    costHeading: 'Wat kost een uitbouw in Apeldoorn?',
    costIntro: 'Uw afwerking, kozijnkeuze en glaspartijen bepalen de prijs. Onderstaande richtprijzen geven een goede indicatie:',
    costRows: [
      { label: 'Prefab uitbouw, per m² (geïnstalleerd)', val: 'circa € 2.500 – € 4.200' },
      { label: 'Compacte uitbouw (ca. 12 m²)', val: 'vanaf circa € 40.000' },
    ...
    costNote: '* Richtbedragen incl. btw en installatie. Op de Veluwse zandgrond is doorgaans een eenvoudiger fundering mogelijk; de exacte calculatie hangt af van uw afwerking en kavelsituatie.',
    steps: [
      { nr: '1', title: 'Advies & Ontwerp', desc: 'We bezoeken uw woning in Apeldoorn en ontwerpen een uitbouw op maat.' },
      { nr: '2', title: 'Vergunningscheck', desc: 'Gratis controle bij de gemeente Apeldoorn; waar nodig regelen wij de aanvraag.' },
      { nr: '3', title: 'Fabricage', desc: 'Uw uitbouw wordt millimeterprecies in onze droge fabriek gebouwd.' },
      { nr: '4', title: 'Fundering & Montage', desc: 'Stevige fundering op de zandgrond en plaatsing in één dag, wind- en waterdicht.' },
      { nr: '5', title: 'Afwerking', desc: 'Beglazing, elektra en afwerking worden voltooid. Uw nieuwe ruimte is direct bruikbaar.' },
    ],
    districtsHeading: 'Bouwen per wijk in Apeldoorn',
    districtsIntro: 'Apeldoorn kent ruime, groene wijken met veel mogelijkheden. Wij stemmen ons ontwerp daarop af:',
    wijken: [
      { name: 'De Maten & Zevenhuizen', desc: 'Ruime naoorlogse wijken met goede achterom-mogelijkheden, ideaal voor royale uitbouwen met veel glas.' },
      { name: 'Ugchelen & Berg en Bos', desc: 'Groene, gewilde buurten aan de Veluwe waar we het ontwerp afstemmen op de landelijke uitstraling.' },
      { name: 'Centrum & Brink', desc: 'Dichter bebouwd, met soms een beschermd karakter. Hier verzorgen wij waar nodig het vergunningstraject.' },
    ],
    analysisBoxes: [
      { eyebrow: 'DE JUISTE KEUZE', title: 'Uitbouw of dakopbouw?', paragraphs: ['Voor extra leefruimte op de begane grond is een uitbouw ideaal: een grotere keuken, woonkamer of eetkamer met tuinzicht.', 'Heeft u boven ruimte nodig? Dan adviseren wij over een dakkapel of dakopbouw die binnen de regels past.'] },
      { eyebrow: 'GOEDE VOORBEREIDING', title: 'Vooraf goed doordacht', paragraphs: ['Kraantoegankelijkheid, erfgrenzen en de zandgrond beoordelen we vooraf nauwkeurig.', 'Daardoor verloopt de montagedag vlekkeloos en sluiten we meerwerk of vertraging uit.'] },
      { eyebrow: 'LICHT & SFEER', title: 'Het Veluwse groen naar binnen', paragraphs: ['Met grote glaspartijen en een lichtstraat haalt u het natuurlijke licht en groen van de Veluwe diep uw woning in.', 'Een uitbouw met schuifpui verbindt uw woonkamer naadloos met de tuin.'] },
      { eyebrow: 'DUURZAAM COMFORT', title: 'Energiezuinig en behaaglijk', paragraphs: ['Met isolatiewaarden tot Rc 6.0 is uw uitbouw warm in de winter en koel in de zomer.', 'Dat verlaagt uw energiekosten en combineert perfect met vloerverwarming of een warmtepomp.'] },
    ],
    extraBlocks: [
      { heading: 'Ruim wonen optimaal benut', paragraphs: [
        'Apeldoorn staat bekend om zijn ruime, groene wijken en vrijstaande woningen. Juist die ruimte maakt een uitbouw extra aantrekkelijk: er is vaak volop plek voor een royale uitbreiding met grote glaspartijen of een lichtstraat die het Veluwse groen naar binnen haalt.',
        'Wij kijken altijd eerst naar uw woningtype en indeling. Een te kleine keuken wordt een ruime leefkeuken, en een groeiend gezin krijgt eindelijk de ruimte die het nodig heeft — zonder dat u Apeldoorn hoeft te verlaten.'] },
      { heading: 'Toekomstbestendig en energiezuinig', paragraphs: [
        'Steeds meer Apeldoorners willen verduurzamen. Een prefab uitbouw sluit daar naadloos op aan: met hoogwaardige isolatie tot Rc 6.0 en voorbereiding op vloerverwarming en warmtepomp draagt uw uitbreiding bij aan een lager energieverbruik.',
        'Zo combineert u extra woonruimte met comfort en duurzaamheid. Uw woning wordt warmer, stiller en zuiniger — en blijft aantrekkelijk op de markt.'] },
    ],
    faqs: [
      { question: 'Wat kost een prefab uitbouw in Apeldoorn?', answer: 'Gemiddeld € 2.500 tot € 4.200 per m². Een uitbouw van 15 m² begint rond de € 44.000, afhankelijk van uw wensen en afwerkingsniveau.' },
      { question: 'Heb ik een vergunning nodig in Apeldoorn?', answer: 'Aan de achterzijde is een uitbouw vaak vergunningsvrij tot vier meter diep. In het buitengebied en bij monumenten gelden soms extra regels. Wij controleren dit gratis voor u.' },
      ...
      { question: 'Moet ik letten op de fundering?', answer: 'Op de Veluwse zandgrond volstaat doorgaans een eenvoudiger fundering. Wij beoordelen de ondergrond altijd per locatie en berekenen de juiste oplossing vooraf.' },
      { question: 'Kan ik een keuken in de uitbouw plaatsen?', answer: 'Ja. Alle leidingen, afvoeren en elektra worden al in de fabriek voorbereid, zodat uw keuken naadloos aansluit.' },
      { question: 'Is prefab wel stevig genoeg?', answer: 'Absoluut. Alles wordt onder gecontroleerde fabrieksomstandigheden gebouwd, wat een constantere en vaak hogere kwaliteit oplevert dan bouwen op locatie.' },
    ],
    noscript: 'Prefab Select bouwt hoogwaardige prefab uitbouwen en aanbouwen in Apeldoorn, waaronder De Maten, Ugchelen en Zevenhuizen. Een uitbouw aan de achterzijde is vaak vergunningsvrij tot vier meter diep. Op de Veluwse zandgrond is een snelle, stabiele plaatsing mogelijk. Richtprijs circa € 2.500 tot € 4.200 per m². Offerte aanvragen? Mail offerte@prefabselect.nl of bezoek www.prefabselect.nl.',
  },
  ...
  ede: {
    ...
    heroImage: 'https://i.imgur.com/fmQecXk.jpeg',
    processImage: 'https://i.imgur.com/covRQg3.jpeg',
    metaTitle: 'Prefab Aanbouw Ede | Meer Ruimte op de Veluwe — Prefab Select',
    metaDescription: 'Een prefab aanbouw of uitbouw in Ede laten bouwen? Lees over kosten, vergunning, bouwen op de Veluwse zandgrond en de aanpak per kern. Prefab Select bouwt snel en vakkundig.',
    heroBadge: 'PREFAB SELECT EDE',
    heroTitleLines: ['Aanbouw in Ede', 'meer ruimte tussen', 'bos en heide'],
    heroIntro: 'Ede ligt midden op de Veluwe, omringd door bos en heide. Wilt u uw woning vergroten zonder lange verbouwing? Prefab Select bouwt een hoogwaardig geïsoleerde aan- of uitbouw — snel geplaatst, stabiel op de zandgrond en met minimale overlast.',
    usps: [
      { title: 'Constructie in 1 dag', sub: 'Ruwbouw direct wind- & waterdicht' },
      { title: 'Stabiel op zandgrond', sub: 'Snelle, vaste fundering' },
      { title: 'Complete ontzorging', sub: 'Van ontwerp tot oplevering' },
    ],
    introEyebrow: 'UITBREIDEN IN PLAATS VAN VERHUIZEN',
    introHeading: ['Wonen blijven', 'op de Veluwe'],
    introParagraphs: [
      'Ede is een gewilde woongemeente met een unieke ligging tussen bos en heide. Of u nu woont in Ede-centrum, het groene Bennekom of in Lunteren: het is een plek waar mensen graag blijven. Met een prefab aanbouw hoeft u niet te verhuizen om meer ruimte te krijgen.',
      'Met een aanbouw van Prefab Select voegt u een lichte leefkeuken, een thuiskantoor of een extra slaapkamer toe. Veel woningen in Ede zijn ruim opgezet of vrijstaand, wat volop mogelijkheden biedt voor een royale uitbreiding met uitzicht op het groen.',
      'Wij verzorgen het complete traject, van ontwerp en vergunningscheck tot productie en plaatsing, zodat u nergens omkijken naar heeft.',
    ],
    benefits: [
      'Binnen 1 dag op locatie geplaatst, direct wind- en waterdicht',
      'Maatwerk voor vrijstaande en twee-onder-een-kapwoningen',
      'Snelle, stabiele plaatsing op de Veluwse zandgrond',
      'Volledige ontzorging: ontwerp, vergunning, productie en plaatsing',
    ],
    processEyebrow: 'GEEN MAANDENLANGE BOUWPLAATS',
    processHeading: ['Droog gebouwd in de fabriek', 'snel gemonteerd op locatie'],
    processParagraphs: [
      'Traditionele aanbouw brengt weersrisico’s, droogtijden en geluidsoverlast met zich mee. Prefab Select bouwt het grootste deel van uw aanbouw vooraf in de fabriek, onder droge en constante omstandigheden.',
      'Op uw kavel leggen we een stevige fundering aan op de zandgrond. Op de montagedag plaatsen we de voorbereide elementen met een kraan; dezelfde avond is uw woning weer wind- en waterdicht. Daarna volgt alleen nog de fijne afwerking.',
    ],
    welstandEyebrow: 'VERGUNNING & ONDERGROND IN EDE',
    welstandHeading: ['Vaak vergunningsvrij', 'altijd goed geregeld'],
    welstandParagraphs: [
      'Een aanbouw aan de achterzijde binnen het achtererfgebied is vaak vergunningsvrij, als richtlijn tot vier meter diep. Wij voeren kosteloos de vergunningcheck uit voor uw adres bij de gemeente Ede.',
      'In het buitengebied van de Veluwe, nabij natuurgebieden of bij monumenten kunnen aanvullende regels gelden. Onze ontwerpers verzorgen waar nodig het volledige vergunnings- en welstandstraject.',
      'Ede ligt op de stevige zandgrond van de Veluwe, gunstig voor een snelle en stabiele plaatsing. Wij beoordelen de ondergrond altijd per locatie, zodat uw aanbouw levenslang stabiel blijft.',
    ],
    costHeading: 'Wat kost een aanbouw in Ede?',
    costIntro: 'Uw afwerking, kozijnkeuze en glaspartijen bepalen de prijs. Onderstaande richtprijzen geven een goede indicatie:',
    costRows: [
      { label: 'Prefab aanbouw, per m² (geïnstalleerd)', val: 'circa € 2.500 – € 4.200' },
      { label: 'Compacte aanbouw (ca. 12 m²)', val: 'vanaf circa € 40.000' },
      { label: 'Ruime of luxe aanbouw (ca. 20 m²)', val: 'tot € 82.000 of meer' },
    ],
    costNote: '* Richtbedragen incl. btw en installatie. Op de Veluwse zandgrond is doorgaans een eenvoudiger fundering mogelijk; de exacte calculatie hangt af van uw afwerking en kavelsituatie.',
    steps: [
      { nr: '1', title: 'Advies & Ontwerp', desc: 'We bezoeken uw woning in Ede en ontwerpen een aanbouw op maat.' },
      { nr: '2', title: 'Vergunningscheck', desc: 'Gratis controle bij de gemeente Ede; waar nodig regelen wij de aanvraag.' },
      { nr: '3', title: 'Fabricage', desc: 'Uw aanbouw wordt millimeterprecies in onze droge fabriek gebouwd.' },
      { nr: '4', title: 'Fundering & Montage', desc: 'Stevige fundering op de zandgrond en plaatsing in één dag, wind- en waterdicht.' },
      { nr: '5', title: 'Afwerking', desc: 'Beglazing, elektra en afwerking worden voltooid. Uw nieuwe ruimte is direct bruikbaar.' },
    ],
    districtsHeading: 'Bouwen per kern in de gemeente Ede',
    districtsIntro: 'De gemeente Ede telt meerdere kernen, elk met een eigen karakter. Wij stemmen ons ontwerp daarop af:',
    wijken: [
      { name: 'Ede-centrum & Veldhuizen', desc: 'Gevarieerde bebouwing met goede mogelijkheden voor een uitbreiding aan de achterzijde.' },
      { name: 'Bennekom & Lunteren', desc: 'Groene, gewilde dorpen met ruime, vaak vrijstaande woningen, ideaal voor royale aanbouwen.' },
      { name: 'Buitengebied & Veluwerand', desc: 'Landelijk gelegen woningen waar we het ontwerp zorgvuldig afstemmen op de natuurlijke omgeving.' },
    ],
    analysisBoxes: [
      { eyebrow: 'DE JUISTE KEUZE', title: 'Aanbouw of dakopbouw?', paragraphs: ['Voor extra leefruimte op de begane grond is een aanbouw ideaal: een grotere keuken, woonkamer of een thuiskantoor.', 'Heeft u boven ruimte nodig? Dan adviseren wij over een dakkapel of dakopbouw die binnen de regels past.'] },
      { eyebrow: 'GOEDE VOORBEREIDING', title: 'Vooraf goed doordacht', paragraphs: ['Kraantoegankelijkheid, erfgrenzen en de zandgrond beoordelen we vooraf nauwkeurig.', 'Daardoor verloopt de montagedag vlekkeloos en sluiten we meerwerk of vertraging uit.'] },
      { eyebrow: 'LICHT & SFEER', title: 'Het Veluwse groen naar binnen', paragraphs: ['Met grote glaspartijen en een lichtstraat haalt u het natuurlijke licht en groen van bos en heide diep uw woning in.', 'Een aanbouw met schuifpui verbindt uw woonkamer naadloos met de tuin.'] },
      { eyebrow: 'DUURZAAM COMFORT', title: 'Energiezuinig en behaaglijk', paragraphs: ['Met isolatiewaarden tot Rc 6.0 is uw aanbouw warm in de winter en koel in de zomer.', 'Dat verlaagt uw energiekosten en combineert perfect met vloerverwarming of een warmtepomp.'] },
    ],
    extraBlocks: [
      { heading: 'Uw woning in Ede optimaal benutten', paragraphs: [
        'In de gemeente Ede staan veel ruime en vrijstaande woningen, vooral in Bennekom, Lunteren en het buitengebied. Die ruimte maakt een aanbouw extra aantrekkelijk: er is vaak volop plek voor een royale uitbreiding die het Veluwse landschap naar binnen haalt.',
        'Wij stemmen het ontwerp af op uw woningtype en wensen. Of het nu gaat om een lichte leefkeuken, een thuiskantoor of een extra slaapkamer op de begane grond — wij realiseren het op maat.'] },
      { heading: 'Duurzaam bouwen op de Veluwe', paragraphs: [
        'Duurzaamheid speelt een grote rol in de gemeente Ede. Een prefab aanbouw past daar uitstekend bij: dankzij efficiënte fabrieksproductie is er minder materiaalverspilling, en met isolatiewaarden tot Rc 6.0 is uw uitbreiding zeer energiezuinig.',
        'Zo investeert u in extra woonruimte én in een toekomstbestendige, comfortabele woning die laag in het energieverbruik blijft.'] },
    ],
    faqs: [
      { question: 'Wat kost een prefab aanbouw in Ede?', answer: 'Gemiddeld € 2.500 tot € 4.200 per m². Een aanbouw van 15 m² begint rond de € 44.000, afhankelijk van afwerking en opties.' },
      { question: 'Heb ik een vergunning nodig in Ede?', answer: 'Vaak is een aanbouw aan de achterzijde vergunningsvrij tot vier meter diep. In het buitengebied van de Veluwe gelden soms aanvullende regels; wij checken dit gratis.' },
      ...
      { question: 'Wat is het verschil tussen een aanbouw en een uitbouw?', answer: 'Een uitbouw is een kleinere uitbreiding van een bestaande ruimte (zoals een verlengde woonkamer); een aanbouw is vaak een volwaardige extra ruimte. Wij adviseren u graag welke oplossing het best past.' },
      { question: 'Kan ik een keuken in de aanbouw plaatsen?', answer: 'Ja. Alle leidingen, afvoeren en elektra worden al in de fabriek voorbereid, zodat uw keuken naadloos aansluit.' },
      { question: 'Is prefab wel stevig genoeg?', answer: 'Absoluut. Alles wordt onder gecontroleerde fabrieksomstandigheden gebouwd, wat een constantere en vaak hogere kwaliteit oplevert dan bouwen op locatie.' },
    ],
    noscript: 'Prefab Select bouwt hoogwaardige prefab aanbouwen en uitbouwen in Ede en de kernen Bennekom en Lunteren. Een aanbouw aan de achterzijde is vaak vergunningsvrij tot vier meter diep. Op de Veluwse zandgrond is een snelle, stabiele plaatsing mogelijk. Richtprijs circa € 2.500 tot € 4.200 per m². Offerte aanvragen? Mail offerte@prefabselect.nl of bezoek www.prefabselect.nl.',
  },
};
